...
$ec "       OOOOO OOOOO"
$ec "       OOOOO OOOOO"
$ec "       OOOOO OOOOO        "$w"Facebook bruteforce v.1.0"
$ec $c"       YOOOO OOOO0"
$ec "        YOOO OOOP      "$r2"["$y"+"$r2"]"$y"==========================="$r2"["$y"+"$r2"]"
$ec $c"   oOOOOOOOOOOOOb      "$r2"[ ]                           [ ]"
$ec $c" oOO"$i"OOOO"$c"OOOOOOOOOb     "$r2"[ ]   "$w"Author by "$r2": "$w"Mr.B3LUX"$r2"    [ ]"
$ec $c" oOO"$i"Ob dO"$c"OOOOOOOOOO    "$r2"[ ]   "$w"FB        "$r2": "$w"Kevin AR    "$r2"[ ]"
$ec $c"OOOO"$i"OOOO"$c"OOOOOOOOOOO    "$r2"[ ]                           [ ]"
$ec $c"OOOOOOOOOOOOOOOOOOP    "$r2"[ ]      "$i"Copyright ©2018      "$r2"[ ]"
$ec $c"OOOOOOOOOOOOOOOOOP     "$r2"[ ]                           [ ]"
$ec $c"YOOOOOOOOOOOOOOP       "$r2"["$y"+"$r2"]"$y"==========================="$r2"["$y"+"$r2"]"
$ec $c"  YOOOOOOOOOOOP"
$ec $i" %%%%%%%%%%%%%%"
$ec $i"%%%%%%"$c"OOOjgsOOO"
